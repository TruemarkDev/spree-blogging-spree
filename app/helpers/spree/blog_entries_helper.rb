module Spree
  module BlogEntriesHelper
    ...
    def blog_full_article_html(blog_entry)
      "<br><br>Read the full article #{link_to blog_entry.title, blog_entry_url_permalink(blog_entry)} at #{link_to "Soapy Soap Company Blog", blog_url}."
    end

    def blog_first_appeared_html(blog_entry)
      "<br><br>The article #{link_to blog_entry.title, blog_entry_url_permalink(blog_entry)} first appeared on #{link_to "Soapy Soap Company Blog", blog_url}."
    end
